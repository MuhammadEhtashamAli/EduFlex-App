...
import '../Kpk_Board_home.dart';

class kSubject9Screen extends StatelessWidget {
  @override
...
class kSubject10Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
...
class kSubject11Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
...
class KSubject12Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => KpkHomePage(subjectName: subjectName)),
        );
      },
      child: Container(
        width: 300,
