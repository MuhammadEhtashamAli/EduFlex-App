...
import '../Punjab_Board_home.dart';

class PSubject9Screen extends StatelessWidget {
  @override
...
class PSubject10Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
...
class PSubject11Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
...
class PSubject12Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => PunjabHomePage(subjectName: subjectName)),
        );
      },
      child: Container(
        width: 300,
