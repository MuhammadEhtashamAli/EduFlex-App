...
class PunjabMcqs extends StatefulWidget {
  const PunjabMcqs({Key? key}) : super(key: key);

  @override
  State<PunjabMcqs> createState() => _PunjabMcqsState();
}

class _PunjabMcqsState extends State<PunjabMcqs> {
  @override
