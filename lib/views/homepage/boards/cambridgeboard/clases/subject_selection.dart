...
import '../Cambridge_Board_home.dart';

class CSubject9Screen extends StatelessWidget {
  @override
...
class CSubject10Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
...
class CSubject11Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
...
class CSubject12Screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  CambridgeHomePage(subjectName: subjectName)),
        );
      },
      child: Container(
        width: 300,
