...
class FederalMcqs extends StatefulWidget {
  const FederalMcqs({Key? key}) : super(key: key);

  @override
  State<FederalMcqs> createState() => _FederalMcqsState();
}

class _FederalMcqsState extends State<FederalMcqs> {
  @override
